...
module.exports = class LeaderBoard extends Command {
	constructor (client) {
		super(client, {
			name: "leaderboard",
			description: "Classement par expérience des membres",
...
/*
           ...
           function makeEmbed(scStart, scEnd) {
            ...
            rankedUsers.forEach(u => {
                ...
                userPlace = rankedUsers.findIndex(u => u.id === `level_${i.guild.id}_${userId}`)+1;
                fields.push({name: `**・${i.guild.members.cache.get(userId)?.user.username}** <:charpe:1130195882432811059> #${userPlace}`, value: `\`\`\`Niveau ${u.value.level} \`\`\``})
            })
